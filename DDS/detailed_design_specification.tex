...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.60\textwidth]{images/demebot}
\end{figure}
\vspace{0.5 in}
...
\begin{versionhistory}
  	\vhEntry{1.0}{03/09/2017}{TM}{initial draft}
\end{versionhistory}
\newpage
...
\input{tex/core_logic_layer_subsystems.tex}
\newpage
\section{Motor Control Layer Subsystems}
\input{tex/motor_control_layer_subsystems.tex}
\newpage
\section{Database Layer Subsystems}
\input{tex/database_layer_subsystems.tex}
\newpage
\section{Web Service Layer Subsystems}
\input{tex/web_service_layer_subsystems.tex}
\newpage
\section{Web Client Layer Subsystems}
\input{tex/web_client_layer_subsystems.tex}
\newpage
